...
const App = () => {
  ...
  const [chatToken, setChatToken] = React.useState('007eJxTYHjHwPbi//wZG+WjZMzim7/UeNavbJn9NVauYuM3LQOXacIKDImGhhZGlsbGSWmJRibmaUYWRhbGRomJiYbmpklmBhYmEyf9TWsIZGTI2LSUlZGBlYERCEF8FQbTpEQjM4NkA10LA0tzXUPD1DTdJItES11L0yRzU3Mz0xTLtBQAVL8nGw==');
  ...
  const login = () => {
    ...
    chatClient
      ...
      const name = chatClient.getCurrentUsername()
